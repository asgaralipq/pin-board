  ...
  <div>
    ...
    <form v-if="showMessageForm" @submit.prevent="addMessage" class="mb-3">
      ...
      <div class="form-group">
        ...
        <textarea v-model="message.message" type="text"
        class="form-control" id="message" value="Enter a message" />
      </div>

      <div class="form-group">
        <label for="imageURL">Image URL</label>
        <input v-model="message.imageURL" type="url"
        class="form-control" id="imageURL" placeholder="Enter a image URL">
      </div>
...
const API_URL = 'http://localhost:1550/messages';
export default {
  name: 'Home',
  data: () => ({
